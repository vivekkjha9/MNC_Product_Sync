        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < axcustomers.Results.Count; i++)
            {
                ...
                try
                {
                    ...
                    {
                        customerCreate.firstname = axcustomers.Results[i].LastName;
                    }
                   ...
                   // customerCreate.lastname = axcustomers.Results[i].LastName;
                    ...
                    if (axcustomers.Results[i].Addresses[0].TwoLetterISORegionName == "")
                    {
                    ...
                    string[] streettxt = { axcustomers.Results[i].Addresses[0].FullAddress };
                    customerAddress.street = streettxt;
                    if (axcustomers.Results[i].Addresses[0].ZipCode=="")
                    {
                    ...
                    {
                        if (axcustomers.Results[i].Addresses[0].Phone.Equals(""))
                        {
